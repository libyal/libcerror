...
static void *(*cerror_test_real_memcpy)(void *, void *, size_t) = NULL;
       ...
       size_t size )
{
	...
	else if( cerror_test_malloc_attempts_before_fail > 0 )
	{
       ...
       size_t size )
{
	...
	else if( cerror_test_memcpy_attempts_before_fail > 0 )
	{
		cerror_test_memcpy_attempts_before_fail--;
	}
	destination = cerror_test_real_memcpy(
	               destination,
	               source,
	               size );
